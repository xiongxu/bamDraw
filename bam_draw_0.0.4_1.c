// gcc -g -O3 -Wall bam_draw_0.0.4_1.c -o bam_draw_0_0_4_1 ../hashtbl.a ./samtools-0.1.19/libbam.a  -I./samtools-0.1.19 -L./samtools-0.1.19 $(pkg-config --cflags --libs cairo) -lpthread
#include <stdio.h>
#include <getopt.h>
#include <math.h>
#include <errno.h>
...
"Example:\n  %s -D -P -g /home/xuxiong/data/hg19/hg19.gtf  -r chr1:1227764-1260067 -O out /share/work1/staff/xuxiong/twins/batch2/test_20131224/*_1224/accepted_hits.bam\n" \
"\n" \
